<x-patient.playout title="Point de vente | Patient" :breadcrum="['Point de vente']" activePage="1">
                    ...
                    <table class="table table-report -mt-2">
                        ...
                        @foreach($medicaments as $med)
                            <tr class="intro-x medicament-row zoom-in hidden"
                                ...
                                <td>
                                    <div class="font-medium w-48 truncate whitespace-nowrap">{{ $med->nom }}</div>
                                </td>
